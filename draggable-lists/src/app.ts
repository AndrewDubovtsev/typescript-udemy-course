...
class ProjectState extends State<Project> {
    ...
    private updateListeners() {
        for (const listenerFn of this.listeners) {
            // Return a copy of the projects array
            listenerFn(this.projects.slice());
        }
    }
}

// A global constant for working with our state
...
abstract class Component<T extends HTMLElement, U extends HTMLElement> {
    ...
    constructor(
        ...
        // Where we want to render the templateElement
...
class ProjectItem extends Component<HTMLUListElement, HTMLLIElement> implements Draggable {
    ...
    @autobind
    dragStartHandler(event: DragEvent): void {
        // We want to copy over the project id
        event.dataTransfer!.setData('text/plain', this.project.id);
        // We plan to move the element from A to B (an alternative is to copy it)
